module SpaceFinder
  ...
  # Входные данные: Массив произвольной длины, начальным значением и количеством
  #   пропущенных чисел. Возможность без затрат
  #   реализовать шаг в массиве(например [36,40,44,48,..]).
  #
